...
interface SimpleSnufferCapInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleSnufferCap extends BaseContract {
  ...
  interface: SimpleSnufferCapInterface;
